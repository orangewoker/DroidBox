...
final class DiagnosticsService {
    ...
    var rows:[(String,String)] {
        ...
        return [("iOS",device.systemVersion),("设备",device.model),("App 版本",Bundle.main.infoDictionary?["CFBundleShortVersionString"] as? String ?? "未知"),("JIT",jitText),("物理内存",ByteCountFormatter.string(fromByteCount:Int64(DBRuntimeProbe.physicalMemory()),countStyle:.memory)),("估算可用内存",ByteCountFormatter.string(fromByteCount:Int64(DBRuntimeProbe.availableMemoryEstimate()),countStyle:.memory)),("Android Runtime",runtimeManager.runtimeMessage),("QEMU Core","未嵌入")]
    }
